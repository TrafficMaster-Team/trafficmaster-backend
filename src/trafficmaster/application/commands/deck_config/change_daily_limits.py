...
class ChangeDailyLimitsCommand:
    deck_config_id: UUID
    daily_limits: DailyLimits


class ChangeDailyLimitsCommandHandler:
    def __init__(
        self,
    ...
    async def __call__(self, data: ChangeDailyLimitsCommand) -> None:
        ...
        deck_config.change_daily_limits(data.daily_limits)
