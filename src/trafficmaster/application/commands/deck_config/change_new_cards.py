...
class ChangeNewCardsCommand:
    deck_config_id: UUID
    new_cards: NewCardsConfig


class ChangeNewCardsCommandHandler:
    def __init__(
        self,
    ...
    async def __call__(self, data: ChangeNewCardsCommand) -> None:
        ...
        deck_config.change_new_cards(data.new_cards)
