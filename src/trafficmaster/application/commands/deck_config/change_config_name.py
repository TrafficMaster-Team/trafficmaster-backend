...
class ChangeConfigNameCommand:
    deck_config_id: UUID
    name: str


class ChangeConfigNameCommandHandler:
    def __init__(
        self,
    ...
    async def __call__(self, data: ChangeConfigNameCommand) -> None:
        ...
        deck_config.change_config_name(DeckConfigName(data.name))
