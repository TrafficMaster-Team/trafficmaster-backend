...
class ChangeImagePathCommand:
    card_id: UUID

    image_path: str | None


class ChangeImagePathCommandHandler:
    def __init__(
        self,
    ...
    async def __call__(self, data: ChangeImagePathCommand) -> None:
        ...
        card.change_image_path(data.image_path)
