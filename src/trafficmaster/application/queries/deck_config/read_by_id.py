...
class ReadDeckConfigByIdQuery:
    deck_config_id: UUID


class ReadDeckConfigByIdQueryHandler:
    def __init__(
        self,
    ...
    async def __call__(self, data: ReadDeckConfigByIdQuery) -> ReadDeckConfigByIDView:
