...
card_progress_table = sa.Table(
    ...
    sa.Column("card_id", sa.UUID(as_uuid=True), sa.ForeignKey("cards.id", ondelete="CASCADE"), nullable=False),
    sa.Column("ease_factor", sa.Float, key="ease_factor_value", nullable=False),
    sa.Column("interval", sa.Integer, key="interval_value", nullable=False),
...
def map_card_progress_table() -> None:
    mapper_registry.map_imperatively(
        ...
        properties={
            ...
            "ease_factor": composite(EaseFactor, card_progress_table.c.ease_factor_value),
            "interval": composite(Interval, card_progress_table.c.interval_value),
