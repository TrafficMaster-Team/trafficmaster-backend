...
from trafficmaster.presentation.http.v1.routes.user.change_user_password.schemas import (
    ChangeUserPasswordRequestSchema,
)

change_user_password_route: Final[APIRouter] = APIRouter(
...
@change_user_password_route.patch(
    "/{user_id}/password",
...
async def change_user_password_by_id(
    request: ChangeUserPasswordRequestSchema,
