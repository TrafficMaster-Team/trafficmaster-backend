...
from trafficmaster.presentation.http.v1.routes.user.change_user_name.schemas import ChangeUsernameRequestSchema

change_username_router: Final[APIRouter] = APIRouter(tags=["User"], route_class=DishkaRoute)
