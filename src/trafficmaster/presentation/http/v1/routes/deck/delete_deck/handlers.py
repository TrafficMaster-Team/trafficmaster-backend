...
delete_deck_route: Final[APIRouter] = APIRouter(tags=["Deck"], route_class=DishkaRoute)
...
@delete_deck_route.delete(
    "/{deck_id}",
    status_code=status.HTTP_204_NO_CONTENT,
    summary="Delete a deck",
    description=getdoc(DeleteDeckCommandHandler),
...
async def delete_deck(
    ...
    interactor: FromDishka[DeleteDeckCommandHandler],
) -> None:
    command: DeleteDeckCommand = DeleteDeckCommand(deck_id=deck_id)
